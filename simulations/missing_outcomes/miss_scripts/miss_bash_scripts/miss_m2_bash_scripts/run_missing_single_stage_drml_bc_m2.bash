#!/bin/bash
#SBATCH --job-name=miss_setting_four_single_stage_drml_bc_m2
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
procedure="single_stage_drml_bc"
...
# sbatch --chdir="$repo" \
#   --job-name="miss_${setting}_single_stage_drml_bc_m2" \
#   --output="$repo/logs/missing_outcomes/$setting/miss_${setting}_single_stage_drml_bc_m2_%j.out" \
#   --error="$repo/logs/missing_outcomes/$setting/miss_${setting}_single_stage_drml_bc_m2_%j.err" \
...
#   simulations/missing_outcomes/miss_scripts/miss_bash_scripts/miss_m2_bash_scripts/run_missing_single_stage_drml_bc_m2.bash